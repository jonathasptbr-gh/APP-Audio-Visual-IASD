...
dois (`Web v5.28 · Shell v1.21`). Num shell antigo (sem `appVersion()`) a
...
| "Conectar a tela" (modo simplificado) | abre a tela do Display (`window.open`) | mesmo `AVNative.openCast()`, com o nome da tela conectada no subtítulo |
...
- **A cada atualização, incrementar a versão visual do Controle**
  ...
  **Versão atual: v5.28** (base web) · **shell 1.21** (`SHELL_VERSION` 13 —
